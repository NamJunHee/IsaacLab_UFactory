...
def main():
    ...
    # x_max, x_min, y_max, y_min, z_max, z_min = 750, 250, 600, -600, 550, 20
    ...
    while simulation_app.is_running():
        ...
        with torch.inference_mode():
            ...
            # angle_cmd = arm_actions.detach().cpu().numpy().flatten().tolist()
            # print(f"angle_cmd: {angle_cmd}")
            
            # arm.set_servo_angle(angle=angle_cmd, speed=5, wait=False)
